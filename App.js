...
import {Platform, StyleSheet, Text, View, TouchableOpacity, NativeModules, ScrollView, Image, Alert} from 'react-native';
...
export default class App extends Component<Props> {
  ...
  pickSingleWithCamera(cropping) {
    ...
    ImagePicker.openCamera({
      ...
      var image = {uri: image.path, width: image.width, height: image.height};
      self.setState({
        image: image,
        images: self.state.images.concat({...image})
      });
